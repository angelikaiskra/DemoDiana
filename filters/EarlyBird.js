...
module.exports = GL.createComponent(
  ({ children: inputImageTexture }) => {
    return <GL.Node
      ...
      uniforms={{
        inputImageTexture,
        inputImageTexture2: resolveAssetSource(require('../assets/earlyBirdCurves.png')),
        inputImageTexture3: resolveAssetSource(require('../assets/earlybirdOverlayMap.png')),
        inputImageTexture4: resolveAssetSource(require('../assets/vignetteMap.png')),
        inputImageTexture5: resolveAssetSource(require('../assets/earlybirdBlowout.png')),
        inputImageTexture6: resolveAssetSource(require('../assets/earlybirdMap.png'))
      }}
    />
  },
  {
