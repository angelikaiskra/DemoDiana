...
module.exports = GL.createComponent(
  ({ children }) => {
    if (!children || children.length !== 2) throw new Error("You must provide 2 children to Sierra");
    const [inputImageTexture, inputImageTexture5] = children;
    return <GL.Node
      shader={shaders.Sierra}
      uniforms={{
        inputImageTexture,
        inputImageTexture2: resolveAssetSource(require('../assets/sierraVignette.png')),
